...
#### Selesai Menambahkan
Setelah selesai, Admin dapat melanjutkan pembuatan restoran atau dapat berhenti menambahkan restoran. Restoran baru pun akan muncul pada akses Lihat Restoran yang Ada seperti di bawah ini.
